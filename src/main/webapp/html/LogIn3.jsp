...
<script>
//4.servlet out printerWriter >> issues always 2 clicks
	...
	$("#Form1").click(function(){
    	if($("#ENO").val()==""){
         ...
         eval("document.form1['EPD'].focus()");              
	    	...
	    	$.ajax ({	//include跳轉問題未解
	    		type :'POST',
				url	: "${pageContext.request.contextPath}/LogIn6?userNo="+userNo+"&userAcc="+userAcc+"&userPwd="+userPwd,
